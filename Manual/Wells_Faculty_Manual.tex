...
%-RM-%\paragraph{Designation}
%-RM-%At the time of registration, or within the first week of classes of either semester, students %-RM-%may designate courses to be graded Pass-Fail. A freshman may elect one course on a Pass-Fail %-RM-%basis, but only in the Spring Semester . A sophomore, junior, or senior may choose two %-RM-%courses each year for which  a grade of Pass or Fail will be received. 
%-RM-%
%-RM-%\paragraph{Regulations}
%-RM-%The following regulations apply:
%-RM-%
%-RM-%\begin{enumerate}[label=\itemLevelA,ref=\itemRefA]
%-RM-%%1.
%-RM-%\item After the first week of classes in either semester, students must petition the Dean of %-RM-%the College to change the basis of grading a course, either from a letter grade to a grade of %-RM-%pass or fail, or from a grade of pass or fail to a letter grade. After the sixth week of %-RM-%classes, such petitions will be approved only in unusual circumstances, such as when there %-RM-%are medical reasons.
%-RM-%
%-RM-%\item Courses so chosen shall not be taken at the same time.
%-RM-%
%-RM-%%3. 
%-RM-%\item Courses so chosen shall not be in a student's major field.
%-RM-%
%-RM-%%4.
%-RM-%\item Courses may be graded Pass with Distinction, Satisfactory, Fail, but must be so %-RM-%designated in the catalog description of the course. If a student takes more than two courses %-RM-%so graded, the additional course or courses shall be considered as courses taken under the %-RM-%Pass-Fail option (see above), except that such courses may be used to satisfy the %-RM-%requirements of a student's special field.
%-RM-%
%-RM-%%5.
%-RM-%\item In the computation of grade point averages, all courses taken on a Pass-Fail or similar %-RM-%basis will be disregarded by the Registrar except for the grades of PD and F, which will have %-RM-%the numerical equivalents of 4.0 and 0, respectively.
%-RM-%
%-RM-%%6.
%-RM-%\item One course so chosen may be used to satisfy the requirements of the minor field, but %-RM-%only at the 100-level.
%-RM-%
%-RM-%\end{enumerate}
%-RM-%
%-RM-%\oldbreak{V-4}
%-RM-%
%-RM-%%('24/89]Section 4. Calculation of Averages
%-RM-%\subsubsection{Calculation of Averages}\modified{/24/89}
%-RM-%
%-RM-%The calculation of a student's grade point average will be based on all the Wells courses and %-RM-%Wells-affiliated courses undertaken following  initial matriculation at Wells College, with %-RM-%these exceptions:
%-RM-%
%-RM-%\begin{enumerate}[label=\arabic*]
%-RM-%%1.
%-RM-%\item Courses in which a grade of P or S has been earned will be handled as noted in \cref{sub%-RM-%:CoursesForGradeOfPassOrFail} above.
%-RM-%
%-RM-%%2.
%-RM-%\item Students may repeat only courses for which they have previously earned a grade\modified{%-RM-%4/8/03}  of ``F'' (or ``U''), or courses that are designated ``repeatable.'' In the case of a %-RM-%course not designated ``repeatable,'' and for which the student received a grade of ``F'' or %-RM-%``U,'' after the repeat both grades will be posted on the transcript and be reflected in the %-RM-%respective semester (term) grade point averages. However, only the higher grade earned will %-RM-%be calculated into the cumulative grade point average. In the case of a course designated ``%-RM-%repeatable,'' every grade earned will be posted on the transcript and be calculated into the %-RM-%semester (term) and cumulative grade point averages. This is true even when a grade of ``F'' %-RM-%or ``U'' is received.
%-RM-%
%-RM-%%3.
%-RM-%\item Courses taken at other institutions, except in Wells-affiliated programs, will not be %-RM-%included in the calculation of the grade point average as a matter of normal practice.
%-RM-%
%-RM-%\end{enumerate}
%-RM-%
%-RM-%%Section 5. Internships              [5/13/93]
%-RM-%\subsubsection{Internships}\modified{5/13/93}
%-RM-%
%-RM-%Any paid internship must be approved by the Faculty sponsor, Faculty coordinator of %-RM-%internships, and the Director of Experiential Learning and Career Services.
